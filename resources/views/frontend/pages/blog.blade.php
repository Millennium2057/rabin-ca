      ...
      <div class="row gy-4 posts-list">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="post-item position-relative h-100">
            ...
            <div class="post-content d-flex flex-column">
              ...
              <a href="{{ route('blogsdetail') }}" class="readmore stretched-link"><span>Read More</span><i
        ...
        <div class="col-xl-4 col-md-6">
          <div class="post-item position-relative h-100">
            ...
            <div class="post-img position-relative overflow-hidden">
              <img src="{{asset('frontend/assets/img/blog/blog-4.jpg')}}" class="img-fluid" alt="">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="post-item position-relative h-100">
            ...
            <div class="post-img position-relative overflow-hidden">
              <img src="{{asset('frontend/assets/img/blog/blog-5.jpg')}}" class="img-fluid" alt="">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="post-item position-relative h-100">
            ...
            <div class="post-img position-relative overflow-hidden">
              <img src="{{asset('frontend/assets/img/blog/blog-6.jpg')}}" class="img-fluid" alt="">
