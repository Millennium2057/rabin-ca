            ...
            <article class="blog-details">
              ...
              <div class="meta-top">
                <ul>
                  ...
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="{{ route('blogsdetail') }}">12
                      Comments</a></li>
                </ul>
              </div><!-- End meta top -->
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="mt-3">
                  ...
                  <div class="post-item mt-3">
                    ...
                    <div>
                      <h4><a href="{{ route('blogsdetail') }}">Nihil blanditiis at in nihil autem</a></h4>
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="{{ route('blogsdetail') }}">Quidem autem et impedit</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="{{ route('blogsdetail') }}">Id quia et et ut maxime similique occaecati ut</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="{{ route('blogsdetail') }}">Laborum corporis quo dara net para</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="{{ route('blogsdetail') }}">Et dolores corrupti quae illo quod dolor</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
